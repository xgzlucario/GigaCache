...
type Cache struct {
	...
	T []int64  `protobuf:"varint,3,rep,packed,name=T,proto3" json:"T,omitempty"`
}
...
var file_cache_proto_rawDesc = []byte{
	...
	0x20, 0x03, 0x28, 0x03, 0x52, 0x01, 0x54, 0x42, 0x27, 0x5a, 0x25, 0x67, 0x69, 0x74, 0x68, 0x75,
